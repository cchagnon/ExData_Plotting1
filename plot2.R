...
## Peer-graded Assignment: EDA Course Project 1, Part 2
## Created by: cchagnon
...
with(hpc, plot(DateAndTime, as.numeric(as.character(Global_active_power)), type="l", xlab="", ylab="Global Active Power (kilowatts)"))
